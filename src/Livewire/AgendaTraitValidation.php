...
trait AgendaTraitValidation
{
    public function prepareForValidation($attributes)
    {
        // Roep de parent versie van prepareForValidation aan om Livewire functionaliteit te behouden
        parent::prepareForValidation($attributes);

        // Controleer of 'slug' leeg is en vul het met een slug-geformatteerde versie van 'title'
        if (empty($this->slug)) {
